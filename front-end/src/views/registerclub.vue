          ...
          <v-layout justify-center>
            <v-flex xs12 sm md5>
              <v-card class="elevation-10">
                <v-toolbar dark flat src="https://cdn.vuetifyjs.com/images/parallax/material2.jpg">
                ...
                <v-card-text>
                  <v-form>
                    <v-alert outlined type="#FFAB91" text>
                      <div class="title">รายละเอียดชมรม</div>
                      <v-row>
                        <v-col cols="12" sm="8">
                          <v-text-field v-model="clubName" label="ชื่อชมรม" name="name" type="tex"></v-text-field>
                        </v-col>
                ...
                <v-row justify="center">
                  <v-card-actions>
                    <v-btn dark flat color="#4CAF50" @click="saveClubs">Next</v-btn>
                  </v-card-actions>
                </v-row>
                ...
                <v-dialog v-model="dialog" max-width="700px">
                  <v-card>
                    ...
                    <v-card-text>
                      ...
                      <v-row justify="center">
                        <v-card-actions>
                          <v-btn dark flat color="#4CAF50" @click="saveRegisterClubs">Save</v-btn>
                        </v-card-actions>
                      </v-row>
                    </v-card-text>
                  </v-card>
